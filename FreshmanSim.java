...
public class FreshmanSim {
    ...
    public static void main(String[] args) {
        StdOut.println("\n" + "Welcome to the Princeton Freshman Simulator!");
        StdOut.println("------------------------------");
        StdOut.println("In this game, you are trying to survive as many days as possible within"
                               + " the hallowed Princeton University gates.");
        StdOut.println(
                "To survive, you must keep track of your health, happiness, charisma, bank balance,"
                        + " and intelligence levels." + "\n");
        StdOut.println("Your health depends on the amount of sleep you get.");
        StdOut.println("Your happiness depends on your GPA and amount of sleep you get. "
                               + "It also gradually decreases as you get deeper into the semester.");
        StdOut.println(
                "Your charisma depends on whether or not you attend social events, and the type of"
                        + " events you get invited to or are involved in depend on your charisma.");
        StdOut.println(
                "Your bank balance depends on how much money you spend at the events you go to. "
                        + "You don't have a job, so be careful with your spending!");
        StdOut.println("Your intelligence depends on your GPA.");
        StdOut.println("------------------------------");
